<template>
  <div class="home-wrap">
    <div class="home_header">二维矩阵之绕自定义中心点旋转的F字母</div>
    <div>
      <h4>tips</h4>
      <ul>
        <li>我们总是绕原点旋转，而 'F' 的原点就是左上角，也就是 (0, 0)</li>
        <li>现在我们可以使用矩阵运算，改变旋转的中心，把原点（左上角）移动到'F' 的中心，见代码130行</li>
...
export default {
  ...
  methods:{
    ...
    async setUMatrix() {
      ...
      this.uMatrix = mat3.translate(this.uMatrix, this.uMatrix, [-50, -75]);
